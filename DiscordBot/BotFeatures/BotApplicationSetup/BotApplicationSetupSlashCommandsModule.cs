...
public class BotApplicationSetupSlashCommandsModule : ApplicationCommandModule<ApplicationCommandContext>
{
    readonly ApplicationDbContext _dbContext;
    readonly GatewayClient _gatewayClient;

    public BotApplicationSetupSlashCommandsModule(ApplicationDbContext dbContext, GatewayClient gatewayClient)
    {
